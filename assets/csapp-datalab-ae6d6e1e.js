import{d as n,o as p,c as l,C as e}from"./app-719938e2.js";const c={class:"markdown-body"},j={title:"csapp-lab datalab",date:"2024-09-12T00:00:00.000Z",tags:["csapp"],brief:"csapp datalab",series:"csapp"},u="",o=n({__name:"csapp-datalab",setup(t,{expose:a}){return a({frontmatter:{title:"csapp-lab datalab",date:"2024-09-12T00:00:00.000Z",tags:["csapp"],brief:"csapp datalab",series:"csapp"},excerpt:void 0}),(r,s)=>(p(),l("div",c,s[0]||(s[0]=[e(`<h1>前言</h1><p>第二次做 csapp 的 lab 了。</p><h1>题目</h1><h2>1. bitXor</h2><p>问题由两个小问题组成。</p><ol><li>取出所有 x 是 1，y 是 0 的比特</li></ol><pre><code class="language-c">x &amp; ~y
